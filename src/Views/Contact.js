...
export default function Contact() {
    return (
        ...
        <section className="relative z-10 overflow-hidden bg-gray-500 py-20 lg:py-[120px]">
            ...
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  ...
                  <h2
                    className="text-gray-900 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                  >
                    Contact Me
                  </h2>
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      <h4 className="text-dark mb-1 text-xl font-bold">Currently Living In</h4>
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-body-color text-base">(704)-620-8199</p>
                    </div>
                  </div>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    <div
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-body-color text-base">ethan.quinlan2016@gmail.com</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div >
                  <form className="relative rounded-lg bg-gray-900 p-8 shadow-lg sm:p-12">
                    <h1></h1>
                    <div className="m-6">
                      <input
                        type="text"
